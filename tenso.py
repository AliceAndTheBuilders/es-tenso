...
parser.add_argument("destination", help="The destination for the data, e.g. http://4.3.2.1:9200 or mydump.zip. If this "
...
parser.add_argument("-cs", "--chunk_size",
                    help="How many docs shall the chunks that will be added at once have at max. This currently only "
                         "works with elasticsearch as datasource.",
                    default=1000)
...
# parser.add_argument("-nz", "--no-zip", help="If this is given the destination will be treated as a directory and no "
#                                            "zipping will be done.", action="store_true")
